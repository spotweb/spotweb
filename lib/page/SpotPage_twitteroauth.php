...
class SpotPage_twitteroauth extends SpotPage_Abs
{
    ...
    public function __construct(Dao_Factory $daoFactory, Services_Settings_Container $settings, $currentSession, $params)
    {
    ...
    public function render()
    {
        ...
        $requestArray = array_merge_recursive(
            $this->_currentSession['user']['prefs']['notifications']['twitter'],
            ['consumer_key'       => $this->_settings->get('twitter_consumer_key'),
