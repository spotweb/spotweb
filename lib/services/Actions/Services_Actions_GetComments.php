...
class Services_Actions_GetComments {
     ...
     */
    public function getSpotComments($msgId, $prevspots, $userId, $start, $length, $language) {
         ...
         * if necessary
         */
        $comments = $svcProvComments->fetchSpotComments($msgId, $prevspots, $userId, $start, $length);
        if (!$tryTranslate) {
            return $comments;
        } # if
