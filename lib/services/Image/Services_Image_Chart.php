...
class Services_Image_Chart {
	...
	function renderChart($chartType, $title, $prepData, $legend) {
		...
		if ($chartType == "bar") {
			...
			$img->setFontProperties(array("FontName"=>$this->_strTtfPath."/liberation-sans/LiberationSans-Bold.ttf","FontSize"=>10));
			$img->drawText($width/2,13,$title,array("Align"=>TEXT_ALIGN_MIDDLEMIDDLE,"R"=>255,"G"=>255,"B"=>255));

			$img->setFontProperties(array("R"=>255,"G"=>255,"B"=>255,"FontName"=>$this->_strTtfPath."/liberation-sans/LiberationSans-Regular.ttf","FontSize"=>9));
			...
			$img->setFontProperties(array("FontName"=>$this->_strTtfPath."/liberation-sans/LiberationSans-Regular.ttf","FontSize"=>9));
