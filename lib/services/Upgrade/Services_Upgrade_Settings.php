...
class Services_Upgrade_Settings
{
    ...
    public function update()
    {
        ...
        //Assure usage of the newer black/whitelists when settingsversion is lower then 37.
        if ($this->_settings->get('settingsversion') < 0.37) {
        ...
        $this->setIfNot('blacklist_url', 'https://spotlist.tk/spotnet/blacklist.xml');
        $this->setIfNot('external_whitelist', true);
        $this->setIfNot('whitelist_url', 'https://spotlist.tk/spotnet/whitelist.xml');
