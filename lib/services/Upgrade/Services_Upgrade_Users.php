...
class Services_Upgrade_Users
{
     ...
     */
    public function passToHash($password)
    {
     ...
     */
    public function createAdmin($firstName, $lastName, $password, $mail)
    {
        ...
        $dbCon->exec('UPDATE usersettings SET userid = 2 WHERE userid = :userid', [':userid' => [$currentId, PDO::PARAM_INT]]);
    }
