...
<?php } else { ?>	
  <a class="nzb" href="<?php echo $setpath ?>index.php?page=getnzbmobile&amp;messageid=<?php echo $spot['messageid']; ?>" target="_blank" title='' data-transition='fade' data-icon="plus" data-rel="dialog" class="ui-btn-right">NZB</a>
<?php } ?>		
