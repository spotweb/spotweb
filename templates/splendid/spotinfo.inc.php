...
?>
            ...
            <div class="comments" id="comments">
            	<h4>Comments <span class="commentcount"># <?php echo $spot['commentcount']; ?></span></h4>
					<ul>
<?php
		$count = 0;
		foreach($comments as $comment) {
			if ($comment['verified']) {
?>
					<li class="<?php $count++; echo ($count % 2 ? "odd" : "even"); ?>"> <strong> Gepost door <span class="user"><?php echo $comment['fromhdr']; ?></span> (<?php echo $comment['userid']; ?>) @ <?php echo $tplHelper->formatDate($comment['stamp'], 'comment'); ?> </strong> <br>
