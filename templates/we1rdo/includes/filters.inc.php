...
<?php if ($tplHelper->allowed(SpotSecurity::spotsec_post_spot, '')) { ?>
					<li><a href="<?php echo $tplHelper->getPageUrl('postspot'); ?>" onclick="return openDialog('editdialogdiv', 'Voeg een spot toe', '<?php echo $tplHelper->getPageUrl('postspot'); ?>', 'newspotform', function() { new spotPosting().postNewSpot(this.form, postSpotUiStart, postSpotUiDone); return false; }, true, null);" class="greyButton newspot">Voeg een spot toe</a></li>
<?php } ?>
					</ul>
				</div>
