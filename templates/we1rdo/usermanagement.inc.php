...
<?php if ($tplHelper->allowed(SpotSecurity::spotsec_edit_other_users, '')) { ?>
			<li><a href="?page=render&amp;tplname=listusers" title="<?php echo ('Userlist'); ?>"><span><?php echo ('Userlist'); ?></span></a></li>
<?php } ?>
			<li><a href="?page=render&amp;tplname=listgroups" title="<?php echo ('Grouplist'); ?>"><span><?php echo ('Grouplist'); ?></span></a></li>
		</ul>
