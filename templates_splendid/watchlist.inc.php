...
if($settings['show_nzbbutton']) { 
    ...
    echo "      <td><a href='?page=watchlist&amp;action=remove&messageid=".$watch['messageid']."'><img src=\"templates_splendid/img/delete.png\" alt=\"Verwijder uit watchlist\" title=\"Verwijder uit watchlist\" border=\"0\" /></a></td>
